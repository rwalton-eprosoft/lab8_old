//
//  ProcedurePickerViewController.m
//  edge
//
...
@interface ProcedurePickerViewController ()

@end

@implementation ProcedurePickerViewController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    //check and set for consistant seperator lines post ios7
